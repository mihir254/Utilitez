    ...
    props.allDishes && props.allIngredients ? <Flex direction={"column"} minHeight={"100vh"} backgroundColor={"blackAlpha.900"}>
      <Show above='md'>
		<Flex userSelect={"none"} height={"145px"} boxShadow={"2xl"} alignItems={"center"} justifyContent={"space-between"} p={10} backgroundColor={"blackAlpha.700"}>
			<Heading color={"whiteAlpha.800"} bgColor={{lg: "blue", md: "green", sm: "pink", base: "purple"}}>Utilit-ez</Heading>
      ...
      <Show below='md'>
		<Flex zIndex={5} userSelect={"none"} height={"145px"} boxShadow={"2xl"} alignItems={"center"} justifyContent={"space-between"} p={10} backgroundColor={"blackAlpha.900"}>
			...
			<Heading color={"whiteAlpha.800"}>{activeComponent}</Heading>
